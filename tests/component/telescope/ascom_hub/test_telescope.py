...
class TestTelescope(unittest.TestCase):
    ...
    def test_flat(self, request):
        ...
        eq_coords = self.telescope._altaz2radec(aa_coords=self.telescope._flat_coordinate, obstime=obstime, decimal_places=2)
        with patch("crac_server.component.telescope.ascom_hub.telescope.datetime") as clock:
            clock.utcnow.return_value = obstime
            self.telescope.flat()
